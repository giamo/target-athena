...
| athena_workgroup                    | String  | No         | (Default: primary) The name of the [workgroup](https://docs.aws.amazon.com/athena/latest/ug/workgroups-benefits.html) in which the query is being started |
